...
export default {
  ...
  args: {
    title: "소개",
    content:
      "Quam et consequuntur modi eum. Ea minus dolorum velit ut ullam perspiciatis ut doloremque voluptate. Quo quisquam earum natus reiciendis magni nobis commodi. Aliquam repudiandae aut voluptatum. Eveniet laboriosam porro con",
  },
};
